...
let ec_tome_data = '{"eccentrictome:mods":{ae2:{0:{Count:1b,id:"ae2:guide"}},aether:{0:{Count:1b,id:"aether:book_of_lore"}},alexsmobs:{0:{Count:1b,id:"alexsmobs:animal_dictionary"}},allthemodium:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"allthemodium:allthemodium"}}},apotheosis:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"apotheosis:apoth_chronicle"}}},byg:{0:{Count:1b,id:"byg:biomepedia"}},cyclic:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"cyclic:cyclic_guide_book"}}},deeperdarker:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"deeperdarker:wanderers_notebook"}}},dimdungeons:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"dimdungeons:guide_book"}}},industrialforegoing:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"industrialforegoing:industrial_foregoing"}}},laserio:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"laserio:laseriobook"}}},minecraft:{0:{Count:1b,id:"minecraft:written_book",tag:{author:"**MINECRAFTUSERNAME**",pages:[\'{"text":"You just lost\\\\nTHE GAME"}\'],resolved:1b,title:"README.md"}}},modularrouters:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"modularrouters:book"}}},patchouli:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"patchouli:monsters_and_girls"}}},powah:{0:{Count:1b,id:"powah:book"}},sebastrnlib:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"sebastrnlib:sebastrn_mods_guide_book"}}},silentgear:{0:{Count:1b,id:"silentgear:guide_book"}},thermal:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"thermal:guidebook"}}},touhou_little_maid:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"touhou_little_maid:memorizable_gensokyo"}}}},"eccentrictome:version":1}';
