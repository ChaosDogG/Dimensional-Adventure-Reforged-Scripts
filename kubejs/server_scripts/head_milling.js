ServerEvents.recipes(event => {
    ...
    head_1(Item.of('kubejs:unprocessed_meme_core').withChance(0.1), 'SMG4_')
    ...
    head_2('create:crafting_blueprint', Item.of('kubejs:unprocessed_creative_core').withChance(0.1), 'polartt')
    head_2('create:crafting_blueprint', Item.of('kubejs:unprocessed_technical_core').withChance(0.1), 'RagePlaysGames')
    ...
    head_2(Item.of('byg:byg_logo').withChance(0.001), Item.of('kubejs:unprocessed_meme_core').withChance(0.1), 'PerfectBidoof')
    head_2(Item.of('byg:byg_logo').withChance(0.001), Item.of('kubejs:unprocessed_meme_core').withChance(0.1), 'Waluigi')
