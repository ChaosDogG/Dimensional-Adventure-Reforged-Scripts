ServerEvents.recipes(event => {
    ...
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"0"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"1"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"1"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"2"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"2"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"3"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"3"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"4"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"4"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"5"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"5"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"6"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"6"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"7"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"7"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"8"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"8"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"9"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"9"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"10"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"10"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"11"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"11"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"12"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"12"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"13"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"13"}}').weakNBT()], Item.of('minecraft:light', '{BlockStateTag:{level:"14"}}').strongNBT(), 100)
    event.recipes.powah.energizing([Item.of('minecraft:light', '{BlockStateTag:{level:"14"}}').weakNBT()], 'light', 100)
