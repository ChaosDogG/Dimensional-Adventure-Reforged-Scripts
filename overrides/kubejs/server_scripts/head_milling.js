ServerEvents.recipes(event => {
    ...
    let head_1 = (output, user) => {
        event.recipes.create.milling(output, Item.of('minecraft:player_head', `{SkullOwner:${user}}`).weakNBT()).id(`crushed_${user}_head`)
    }
    let head_2 = (outputA, outputB, user) => {
        event.recipes.create.milling([outputA, outputB], Item.of('minecraft:player_head', `{SkullOwner:${user}}`).weakNBT()).id(`crushed_${user}_head`)
    }
    let head_3 = (outputA, outputB, outputC, user) => {
        event.recipes.create.milling([outputA, outputB, outputC], Item.of('minecraft:player_head', `{SkullOwner:${user}}`).weakNBT()).id(`crushed_${user}_head`)
    }
    let head_4 = (outputA, outputB, outputC, outputD, user) => {
        event.recipes.create.milling([outputA, outputB, outputC, outputD], Item.of('minecraft:player_head', `{SkullOwner:${user}}`).weakNBT()).id(`crushed_${user}_head`)
    }
    ...
    head_2(Item.of('thermal:diamond_dust').withChance(0.01), 'chest', 'itsCraftee')
    ...
    head_2('botania:cosmetic_cat_ears', Item.of('kubejs:unprocessed_technical_core').withChance(0.25), 'AxelTheModder')
    ...
    head_3('pink_wool', 'yellow_wool', Item.of('sheep_spawn_egg').withChance(0.25), 'Zedaph')
    head_3('quark:trowel', Item.of('kubejs:unprocessed_creative_core').withChance(0.1), Item.of('cat_spawn_egg').withChance(0.25), 'GoodTimeWithScar')
    head_3('tnt', Item.of('ae2:tiny_tnt').withChance(0.25), Item.of('stick').withChance(0.1), 'Rocket')
    ...
    head_3(Item.of('kubejs:unprocessed_creative_core').withChance(0.1), 'quark:trowel', 'clock', 'BdoubleO100')
    head_3(Item.of('kubejs:unprocessed_creative_core').withChance(0.1), Item.of('kubejs:unprocessed_technical_core').withChance(0.1), 'redstone', 'Tango')
    head_3(Item.of('kubejs:unprocessed_creative_core').withChance(0.1), Item.of('kubejs:unprocessed_technical_core').withChance(0.1), 'redstone', 'TangoCam')
    head_3(Item.of('kubejs:unprocessed_technical_core').withChance(0.1), Item.of('alexsmobs:spawn_egg_lobster').withChance(0.25), 'cfm:rainbow_sofa', 'MrCrayfish')
    ...
    head_3(Item.of('tconstruct:flint_shuriken').withChance(0.25), Item.of('tconstruct:quartz_shuriken').withChance(0.25), Item.of('kubejs:unprocessed_competitive_core').withChance(0.1), '_naruto')
    head_3(Item.of('tconstruct:flint_shuriken').withChance(0.25), Item.of('tconstruct:quartz_shuriken').withChance(0.25), Item.of('kubejs:unprocessed_competitive_core').withChance(0.1), 'Sasuke')
    head_3(Item.of('tconstruct:flint_shuriken').withChance(0.25), Item.of('tconstruct:quartz_shuriken').withChance(0.25), Item.of('kubejs:unprocessed_evil_core').withChance(0.01), 'Itachi')

    head_4('etched:music_label', 'etched:blank_music_disc', Item.of('kubejs:unprocessed_creative_core').withChance(0.1), 'jukebox', 'C418')
